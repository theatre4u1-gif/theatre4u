              ...
              {isCurrentPlan
                ...
                : p.id.endsWith("enterprise")
                  ...
                  : billing === "invoice"
                    ...
                    : gated
                      ? <button className="btn btn-full" disabled title={billingPaused && !beforeLaunch ? "Subscriptions are temporarily paused" : "Billing begins September 1, 2026"} style={{marginTop:"auto",background:"rgba(240,230,211,.08)",border:"1px solid rgba(212,168,67,.35)",color:"rgba(240,230,211,.72)",fontWeight:700,cursor:"default",fontFamily:"inherit",whiteSpace:"normal",textAlign:"center",lineHeight:1.3,fontSize:12.5}}>{billingPaused && !beforeLaunch ? "Subscriptions paused — check back soon" : "Free plan available"}</button>
