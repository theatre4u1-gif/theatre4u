...
const DOOR_DEFAULTS = {
  theatre4u: {
    ...
    "landing.announcement.text": "⭐ Now live. Start free, upgrade to Pro any time.",
    ...
    "landing.pricing.banner":   "⭐ Start free with up to 25 items. Upgrade to Pro any time.",
...
const SECTIONS = [
  ...
  { title: "Pricing — section text only (not the actual prices/charges)", fields: [
    ...
    { key: "landing.pricing.banner_show", label: "Show the announcement banner", type: "checkbox" },
    { key: "landing.pricing.banner",      label: "Announcement banner text",     type: "text" },
