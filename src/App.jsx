...
// ══ Theatre4u Logo — real comedy/tragedy masks icon (embedded, no file deps) ═══
// Source: Theatre4u_LogoDk.svg → masks-only PNG, resized and embedded as base64
// icon_44 = 39×44px for sidebar | icon_80 = 71×80px for loading/hero
const _T4U_ICON_SM = "data:image/png;base64,";
const _T4U_ICON_LG = "data:image/png;base64,";

// LogoMarkDark — theatre masks icon, gold on dark — sidebar + dark panels
// Use size="sm" (39×44) or size="lg" (71×80), or pass a number for custom height
const LogoMarkDark = ({size="sm"}) => {
  const src = (size === "lg" || (typeof size === "number" && size > 55)) ? _T4U_ICON_LG : _T4U_ICON_SM;
  const h   = typeof size === "number" ? size : size === "lg" ? 80 : 44;
  const w   = Math.round(h * 231 / 257);
  return <img src={src} width={w} height={h} alt="" style={{flexShrink:0,display:"block"}}/>;
};

// LogoMarkLight — same icon (gold reads on both dark and light/cream backgrounds)
const LogoMarkLight = ({size="sm"}) => <LogoMarkDark size={size}/>;

// Non-React fallback (QR prints etc)
...
.sb-name{font-family:'Cormorant Garamond','Playfair Display',serif;font-size:20px;color:var(--gold);letter-spacing:.5px;line-height:1.1;font-weight:700}
.sb-sub{font-size:9px;color:var(--t3);text-transform:uppercase;letter-spacing:2.5px;margin-top:3px;font-weight:600}
          ...
          <div className="sb-root">
            ...
            <div className="sb-inner">
              <div className="sb-logo">
                <div style={{display:"flex",alignItems:"center",gap:10}}>
                  <LogoMarkDark size="sm"/>
                  <div>
                    <div className="sb-name">Theatre4u™</div>
                    <div className="sb-sub">Inventory · Exchange</div>
                  </div>
                </div>
